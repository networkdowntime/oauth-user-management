...
async def assign_role_to_user(user_id: str, role_id: str, user_service: UserService = Depends(get_user_service)):
...
async def remove_role_from_user(user_id: str, role_id: str, user_service: UserService = Depends(get_user_service)):
...
async def lock_user(user_id: str, user_service: UserService = Depends(get_user_service)):
    """Lock a user account."""
...
async def unlock_user(user_id: str, user_service: UserService = Depends(get_user_service)):
